    ...
    <div class="mx-auto px-4">
      ...
      >
        ...
        <div class="font-mono text-xs text-gray-500 dark:text-gray-400">
          <p>© {{ currentYear }} Rob Moore</p>
        </div>

        <!-- Center - Social Links -->
        <div class="flex items-center gap-5 text-gray-600 dark:text-gray-400">
          <a
        ...
        <!-- Right side - Links -->
        <div
          class="flex items-center gap-4 font-mono text-xs text-gray-500 dark:text-gray-400"
        >
          Consciousness × Code
        </div>
      </div>
